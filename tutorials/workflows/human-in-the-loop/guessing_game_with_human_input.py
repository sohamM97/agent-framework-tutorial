...
class TurnManager(Executor):
    ...
    async def start(self, _: str, ctx: WorkflowContext[AgentExecutorRequest]) -> None:
        ...
        await ctx.send_message(
            AgentExecutorRequest(messages=[user], should_respond=True)
        )
...
# TODO: there is a mistake in printing here. Try to figure out yourself without claude.
